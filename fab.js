// fab.js - Floating Action Button and Contact Popup Components
...
const FloatingActionButton = ({ isPopupOpen, isMenuOpen, isChatOpen, isExpanding, onClick }) => {
  if (isPopupOpen || isMenuOpen || isChatOpen) return null;
...
const ContactPopup = ({ isPopupOpen, onClose }) => {
...
window.ContactPopup = ContactPopup;
